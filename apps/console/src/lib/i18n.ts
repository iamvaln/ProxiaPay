...
const STRINGS: Record<string, { en: string; fr: string }> = {
  ...
  'second.enrol': { en: 'Scan this secret into an authenticator application, then enter the code it shows.', fr: 'Enregistrez ce secret dans une application d’authentification, puis saisissez le code affiché.' },
